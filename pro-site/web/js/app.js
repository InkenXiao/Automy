...
const App = {
  ...
  switchView(viewName) {
    ...
    // 触发对应模块的 onShow 回调
    const modules = { WeeklyReport, ProgressPlan, WorkTasks, Meeting };
    const mod = viewName === 'weekly-report' ? WeeklyReport
      : viewName === 'progress-plan' ? ProgressPlan
      : viewName === 'work-tasks' ? WorkTasks
      : viewName === 'meeting' ? Meeting
      : null;
